  ...
  return (
    <main className={`mission-control${critical ? ' mc-critical' : ''}`}>
      ...
      <section className="mc-mission">
        <div><div className="mc-eyebrow">HOW IT WORKS</div><h1>Vega can’t hear the crew. Something is forging her orders.</h1><p>Every order is signed. <b className="mc-ok">SEALED</b> is real. <b className="mc-bad">BROKEN SEAL</b> is a forgery. With about 30 seconds left, a stolen key makes forgeries look SEALED too.</p></div>
